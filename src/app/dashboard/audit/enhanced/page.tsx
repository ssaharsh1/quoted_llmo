      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 lg:p-8">
        <div className="w-full max-w-3xl mx-auto flex flex-col gap-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground dark:text-gray-400 max-w-xl mx-auto">
              Analyze your content's optimization for AI models and search engines
            </p>
          </div>

          {/* Main Form Card */}
          <Card className="border border-border/50 dark:border-gray-600/50 shadow-lg dark:shadow-gray-900/20 w-full">
